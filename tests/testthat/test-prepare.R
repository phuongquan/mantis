...
test_that("validate_df_to_inputspec() checks that timepoint column doesn't contain NAs", {
  df <- data.frame(
    timepoint = c(seq(as.Date("2022-01-01"), as.Date("2022-01-09"), by = "days"), NA),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'day'", {
  ...
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-01 12:00:00"), as.POSIXct("2022-01-10 12:00:00"), by = "days"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
  ...
  df <- data.frame(
    timepoint = seq(as.POSIXlt("2022-01-01 12:00:00"), as.POSIXlt("2022-01-10 12:00:00"), by = "days"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'week'", {
  ...
  # with time portion
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-01 12:00:00"), as.POSIXct("2022-03-05 12:00:00"), by = "week"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'month'", {
  ...
  # with time portion
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-02 12:00:00"), as.POSIXct("2022-10-02 12:00:00"), by = "month"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'quarter'", {
  ...
  # good types
  df <- data.frame(
    timepoint = seq(as.Date("2022-01-02"), as.Date("2024-04-02"), by = "quarter"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
  ...
  # with time portion
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-02 12:00:00"), as.POSIXct("2024-04-02 12:00:00"), by = "quarter"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'year'", {
  ...
  # with time portion
  df <- data.frame(
    timepoint = seq(as.POSIXct("2013-01-02 12:00:00"), as.POSIXct("2022-01-02 12:00:00"), by = "year"),
    item = rep(1, 10),
    value = rep(3, 10),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'hour'", {
  ...
  # good types
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-02 12:00:00"), as.POSIXct("2022-01-12 12:00:00"), by = "hour"),
    item = rep(1, 241),
    value = rep(3, 241),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'min'", {
  ...
  # good types
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-02 12:00:00"), as.POSIXct("2022-01-03 12:00:00"), by = "min"),
    item = rep(1, 1441),
    value = rep(3, 1441),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that timepoint_col matches inputspec timepoint_unit of 'sec'", {
  ...
  # good types
  df <- data.frame(
    timepoint = seq(as.POSIXct("2022-01-02 12:00:00"), as.POSIXct("2022-01-02 13:00:00"), by = "sec"),
    item = rep(1, 3601),
    value = rep(3, 3601),
    stringsAsFactors = FALSE
  )
...
test_that("validate_df_to_inputspec() checks that duplicate timepoint-item combinations not allowed", {
  # single item_col
  df <- data.frame(
    timepoint = rep(seq(as.Date("2022-01-01"), as.Date("2022-01-10"), by = "days"), 5),
...
test_that("arrange_items() sorts by single item_order", {
  df <- data.frame(
    timepoint = rep(seq(as.Date("2022-01-01"), as.Date("2022-01-09"), by = "days"), 3),
