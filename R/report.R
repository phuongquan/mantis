...
#'
#' @param df
#' @param colspec use colspec()
#' @param outputspec use outputspec()
...
#' Save a grouped table to an html file
#'
#' @param df
#' @param colspec use colspec()
#' @param outputspec use outputspec()
...
#' @return path to saved file
#' @export
export_grouped_table_html <- function(df,
                              colspec,
                              outputspec = NULL,
                              page_title = "tinduck grouped table",
                              save_directory = ".",
                              save_filename = NULL,
                              show_progress = TRUE,
                              ...) {
