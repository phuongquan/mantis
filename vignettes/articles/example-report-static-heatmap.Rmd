...
filename <- 
  ...
  save_filename = "example-report-static-heatmap",
  show_progress = FALSE
)
...
```{=html}
<iframe src="https://phuongquan.github.io/mantis/articles/example-report-static-heatmap.html" width="100%" height="900">
</iframe>
```
