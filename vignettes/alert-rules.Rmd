...
The report now includes a column for the alert results, and details can be seen by clicking on the triangles. Also, the tab labels will include an exclamation mark if any items in that tab have failed an alert rule.
